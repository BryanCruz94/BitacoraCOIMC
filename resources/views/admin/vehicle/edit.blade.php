        ...
        <div class="modal-content">
            ...
            <form id="forEditVehicle" action="{{ route('vehicles.update') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select name="military_unit_id" id="military_unit_id" class="form-control">
                                    @foreach ($military_units as $military_unit)
                                        <option value="{{ $military_unit->id }}" @if ($vehicle->military_unit_id == $military_unit->id)
                                            selected @endif>
                ...
                <div class="modal-footer">
                    <a type="button" href="{{route('vehicles.index')}}" class="btn btn-danger" data-dismiss="modal">CANCELAR</a>
