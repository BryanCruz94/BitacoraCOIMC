...
<div class="modal" tabindex="-1" id="modalVehIn">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="forNewVehicle" action="{{ route('vehicles.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="military_unit_id" id="military_unit_id" class="form-control">
                                    @foreach ($military_units as $military_unit)
                                        ...
                                        <option value="{{ $military_unit->id }}">{{ $military_unit->abbreviation }}</option>
