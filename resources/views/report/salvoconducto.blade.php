<div style="display: flex; width: 100%;">
    ...
    border-bottom: 1px dashed rgb(63, 62, 62); margin-left:2px; padding-bottom:2px">
        <div style="text-align: center; border-collapse: collapse;">
            <h2 style="padding: 0; margin: 3px; margin-top: 4px; font-size: 14px;">
                FUERTE MILITAR "ECUADOR"</h2>
            <h3 style="padding: 0; margin: 3px; margin-top: 2px; font-size: 14px;">
                ORDEN DE CIRCULACIÓN</h3>
            <div style="font-size: 11px;">
                <div>
                    Fecha:
            ...
            <div style="display: flex; flex-direction: column; width: 90%;">
                ...
                <table style="border-collapse: collapse; width: 100%; text-align: center; font-size: 12px;">
                    <tr>
                        <td style="padding: 5px; text-align: left;">Destino:</td>
                        <td style="padding: 5px; text-align: left;">Quito</td>
                    </tr>

                    <tr>
                        <td style="padding: 5px; text-align: left;">Vehículo:</td>
                        <td style="padding: 5px; text-align: left;">Ford Ranger Negro</td>
                        <td style="padding: 5px; text-align: left;">Placa:</td>
                        <td style="padding: 5px; text-align: left;">PCV-8005</td>
                    </tr>

                    <tr>
                        <td style="padding: 5px; text-align: left;">Misión:</td>
                        <td colspan="3" style="padding: 5px; text-align: left;">Dar seguridad presidencial</td>
                    </tr>
