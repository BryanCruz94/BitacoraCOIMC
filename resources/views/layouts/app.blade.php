...
<head>
    ...
    <title>@yield('title', 'Fuerte Militar Ecuador')</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}">{!! __('<strong>Ingreso</strong>') !!}</a>
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}">{!! __('<strong>Registro</strong>') !!}</a>
                                </li>
                            @endif
                        @else
